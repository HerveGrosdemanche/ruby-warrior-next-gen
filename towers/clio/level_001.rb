...
'"And by the way, what do you think you did in my castle? Why did you go and murder all our poor guards and clerks? Explain yourself!"\n'\
...
'"But on your way out, do me a favor. I need a survey of the kingdom done. See my clerk out there for the details."\n'\
'He then leaves the room.\n'
tip "Use warrior.talk to (maybe) get additional information from clerks"
...
unit :clerk, 10, 5, :west do |u|
  u.add_abilities :answer!
  u.abilities[:answer!].response = "bla bla bla"
end
unit :clerk, 10, 7, :west
